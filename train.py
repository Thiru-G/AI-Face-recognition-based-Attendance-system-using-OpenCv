...
def TrackImages():
    ...
    recognizer.read("D:\Projects\Face-Recognition-Based-Attendance-System-master\TrainingImageLabel\Trainner.yml")
    harcascadePath = "haarcascade_frontalface_default.xml"
...
copyWrite.insert("insert", "Developed by Thiru","", "Vloginnovations", "superscript")
